...
## uncomment -mmacosx-version-min=10.8 if you are linking the tetgen file
## against a library/binary built with SDK 10.8
## (i.e. with -stdlib=libstdc++ instead of -stdlib=libc++)
CXXFLAGS = -g -O2 -DNDEBUG #-mmacosx-version-min=10.8
